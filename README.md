...
`1` Muestra variables del runtime<br>
`2` Oculta las variables<br>
`3` Guarda el log del runtime en `log.txt`
# Creditos
- [Scratch Everywhere!](https://github.com/ScratchEverywhere/ScratchEverywhere) por inspirar este proyecto<br>
- El equipo MIT por hacer Scratch Jr<br>
